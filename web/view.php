...
<a class="pure-button pure-button-success" href="<?php echo $path; ?>/index.php?action=contact&id=<?php echo $donnees['id'] ?>" >Contacté <img width="14" src="<?php echo $path; ?>/img/contact.png"/></a>
<a class="pure-button" href="<?php echo $path; ?>/form.php?id=<?php echo $donnees['id'] ?>">Modifier</a>
